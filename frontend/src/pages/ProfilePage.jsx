...
import { buildAvatarUrl, normalizeAvatarUrl } from "../lib/utils";
...
const ProfilePage = () => {
  ...
  const handleRandomAvatar = () => {
    ...
    const randomAvatar = buildAvatarUrl(idx);
              ...
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="size-32 rounded-full bg-base-300 overflow-hidden">
                  {formState.profilePic ? (
                    <img
                      src={normalizeAvatarUrl(formState.profilePic, formState.fullName || "user")}
                      alt="Profile preview"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" onClick={resetChanges} className="btn btn-ghost btn-sm">
